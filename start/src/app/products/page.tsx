    ...
    <div>
      ...
      <div className="flex flex-wrap mt-10 lg:px-12 justify-items-center">
        {filteredProducts.map((product) => (
          <div
            key={product._id}
            className="sm:ml-8 mt-10 ml-4 lg:w-[226px] md:w-[200px] sm:w-[130px] h-auto flex flex-col justify-between"
          >
            <Image
              src={product.image}
              alt={product.title}
            ...
            <div className="flex flex-row mt-6 space-x-4 items-center">
              <Link
                href={
                  "https://buy.stripe.com/test_aEU16B1HRdK98xy7sw?prefilled_email=lankeshpathmaraj%40gmail.com"
                }
              >
              ...
              <button className="w-[40px] sm:w-[50px] lg:w-[60px] h-[40px] sm:h-[50px] lg:h-[60px] bg-[#161A1D] text-black rounded justify-center items-center hidden lg:flex">
                <svg
                  width="59"
                  height="48"
                  viewBox="0 0 59 48"
