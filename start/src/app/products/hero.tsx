...
const HeroSection: FC<HeroSectionProps> = ({ heroImage, searchQuery, setSearchQuery }) => {
  return (
    <div>
      <div
        className="relative w-full h-auto aspect-[1920/477] bg-cover bg-center md:pb-4 sm:pb-6"
        style={{
          backgroundImage: `url(${heroImage})`, // Use the passed heroImage prop
        }}
      >
