...
const HeroSection: FC<HeroSectionProps> = ({ heroImage = HeroProduct.src, onSearch }) => {
        ...
        <div className="flex flex-col items-center justify-center text-center z-10 sm:py-2">
          ...
          <div className="mt-6 flex items-center">
            ...
            <button
              ...
              className="lg:px-8 lg:py-3 md:px-6 md:py-2 sm:px-4 sm:py-1 bg-white text-black font-bold rounded-full hover:bg-gray-200"
            >
              Search
            </button>
          </div>
