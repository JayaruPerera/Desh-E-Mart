  ...
  return (
    <div className="relative max-w-[220px] rounded-md overflow-hidden shadow-lg hover:bg-[#1E1E1E]">
      <div className="flex justify-between items-center mb-2">
        ...
        {inStock ? (
            <span className="absolute top-[20px] right-[12px] text-[12px] font-normal text-[#FCFDFF] bg-green-500 px-2 py-1 rounded">
                In Stock
            </span>
        ) : ( <span className="absolute top-[20px] right-[12px] text-[12px] font-normal text-[#FCFDFF] bg-red-500 px-2 py-1 rounded">
          Out Stock
        </span> )}
